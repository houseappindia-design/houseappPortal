...
import { postContactContent,fetchContactContent  } from '../../data/slices/contactSlice';
import { useDispatch, useSelector } from 'react-redux';
;


function ContactUsPage() {
const { error, loading, content } = useSelector((state) => state.contact);
...
useEffect(()=>{
  ...
  const submitConfiguration = async () => {
    ...
    try {
        dispatch(postContactContent(content))
